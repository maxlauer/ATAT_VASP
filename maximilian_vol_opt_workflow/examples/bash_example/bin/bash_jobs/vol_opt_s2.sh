...
calc_path=$(python /home/mlauer/Documents/work/sanna/volume_workflow/bin/step_2_preprocessing.py --calc_dir $1 --volume_deviation $2 2>&1 >/dev/null)
...
echo "mv" $calc_path $output_path"/calc_gen_pre"

mv $calc_path $output_path"/calc_gen_pre"

example=$R"/example_calc/example/step_2/"$subdir
...
exit_code=$(python /home/mlauer/Documents/work/sanna/volume_workflow/bin/step_2_postprocessing.py --root $OR --calc_path $calc_path --slurm_id $sid)
echo $exit_code
